		...
		protected function _register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'default'       => '#333',
					'selectors'     => [
						'{{WRAPPER}} .jltma-counterup h3.jltma-counterup-number'      => 'color: {{VALUE}};'
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector'      => '{{WRAPPER}} .jltma-counterup h3.jltma-counterup-number',
					'exclude'       => [
			...
			$this->add_control(
				...
				[
					...
					'size_units'    => [ 'px', 'em', '%' ],
					'selectors'     => [
						'{{WRAPPER}} .jltma-counterup h3.jltma-counterup-number' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);

<?php
	 ...
	 */
	class Master_Addons_Particles extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'MA Particles', MELA_TD );
		}
		...
		public function get_icon() {
			return 'ma-el-icon eicon-apps';
		}


		protected function _register_controls($element, $section_id, $args) {
			if ( ('section' === $element->get_name() && 'section_background' === $section_id) || ('column' === $element->get_name() && 'section_style' === $section_id)) {
				/*
				 * Master Addons: Particles Content
				 */
...
//	Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_Particles() );

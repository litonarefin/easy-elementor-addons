...
//				add_action( 'init', [ $this, 'ma_el_init' ] );
            ...
            function ma_el_freemius_hooks(){

	            $fs= $this->ma_el_fs();

	            $fs->add_filter( 'show_first_trial_after_n_sec', [$this, 'ma_el_fs_show_first_trial_after_7_days']);

	            $fs->add_filter( 'reshow_trial_after_every_n_sec', [$this,'ma_el_fs_reshow_trial_after_every_60_days']);
	            ...
	            $fs->add_filter( 'is_submenu_visible', [$this, 'ma_el_fs_is_submenu_visible'], 10, 2 );

	            $fs->add_filter('checkout/purchaseCompleted', [$this, 'ma_el_fs_after_purchase_js' ]);

	            $fs->add_filter( 'show_admin_notice', [$this, 'ma_el_fs_custom_show_admin_notice'], 10, 2 );


	            $fs->add_filter( 'permissions_list', [$this, 'ma_el_fs_add_helpscount_permission' ]);


	            $fs->add_filter('connect_message_on_update', [$this, 'ma_el_fs_custom_connect_message_on_update'],
                    10, 6);

//	             Not like register_uninstall_hook(), you do NOT have to use a static function.
	            $fs->add_action('after_uninstall', [$this, 'ma_el_fs_uninstall_cleanup']);

	            add_action( 'wp_head', [$this,'ma_el_fs_add_licensing_helper' ]);

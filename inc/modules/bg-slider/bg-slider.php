...
?>
	...
	function _print_template($template, $widget)
	{
		...
		ob_start();
	?>
		<# var rand_id=Math.random().toString(36).substring(7); var slides_path_string='' ; var ma_el_transition=settings.ma_el_slider_transition; var ma_el_animation=settings.ma_el_slider_animation; var ma_el_custom_overlay=settings.ma_el_custom_overlay_switcher; var ma_el_overlay='' ; var ma_el_cover=settings.ma_el_slider_cover; var ma_el_delay=settings.ma_el_slider_delay; var ma_el_timer=settings.ma_el_slider_timer_bar; if(!_.isUndefined(settings.ma_el_bg_slider_images) && settings.ma_el_bg_slider_images.length){ var slider_data=[]; slides=settings.ma_el_bg_slider_images; for(var i in slides){ slider_data[i]=slides[i].url; } slides_path_string=slider_data.join(); } if(settings.ma_el_custom_overlay_switcher=='yes' ){ //if(settings.ma_el_slider_custom_overlay_image.url){ //ma_el_overlay=settings.ma_el_slider_custom_overlay_image.url; //}else{ ma_el_overlay='00.png' ; //} }else{ if(settings.ma_el_slider_overlay){ ma_el_overlay=settings.ma_el_slider_overlay + '.png' ; }else{ ma_el_overlay='00.png' ; } } #>

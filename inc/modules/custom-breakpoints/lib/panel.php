			...
			<div class="elementor-panel-footer-sub-menu">
				...
				<?php $original_file = file_get_contents( JLTMA_MCB_PLUGIN_PATH . '/custom_breakpoints.json');
					...
					<div class="elementor-panel-footer-sub-menu-item" data-device-mode="<?php echo $key;?>">
						<i class="elementor-icon eicon-device-mobile master-cbp-device-<?php echo $value['orientation']; ?> master-cbp-<?php echo $key;?>" aria-hidden="true"></i>
...
<script type="text/template" id="tmpl-elementor-control-responsive-switchers">
	<div class="elementor-control-responsive-switchers">
		...
		<?php
	        ...
	        $jltma_mcb = array();
			foreach($custom_breakpoints as $key => $value) $jltma_mcb[] = $key;

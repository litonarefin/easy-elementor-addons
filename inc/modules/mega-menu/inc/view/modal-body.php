<div class="jltma-pop-contents-body">
    <div class="jltma-pop-contents-padding">
        ...
        <div class="jltma-modal-header">
            <ul class="jltma-tabs jltma_menu_control_nav">
                ...
                <div class="jltma-tab-pane" id="general_tab">
                    ...
                    <div class="option-table jltma-label-container">
                        <div class="jltma-row">
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-8 <?php if( !ma_el_fs()->can_use_premium_code()) { echo "jltma-disabled"; }?>">
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-4 jtlma-mega-switcher <?php if( !ma_el_fs()->can_use_premium_code()) { echo "jltma-disabled"; }?>">
                ...
                <div class="jltma-tab-pane" id="icon_tab">
                    ...
                    <div class="option-table jltma-label-container">
                        <div class="jltma-row">
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-7 <?php if( !ma_el_fs()->can_use_premium_code()) { echo "jltma-disabled"; }?>">
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-5 <?php if( !ma_el_fs()->can_use_premium_code()) { echo "jltma-disabled"; }?>">

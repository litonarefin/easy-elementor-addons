...
<div class="master_addons_feature">
	...
	<?php foreach (array_slice(Master_Elementor_Addons::$maad_el_default_widgets, 38, 6) as
		$key => $widget) : ?>
		...
		<div class="master-addons-dashboard-checkbox col">
			...
			<div class="master-addons-dashboard-checkbox-content">
				...
				<div class="master_addons_feature_switchbox">
					...
					switch-primary switch-pill <?php if (!ma_el_fs()->can_use_premium_code() && isset($is_pro) && $is_pro != "") {
													echo "ma-el-pro";
												} ?>">

    ...
    <div class="jltma-master-addons-features is-flex">
        ...
        <div class="jltma-right_column">
            ...
            <div class="jltma-master-addons-right-column-widget">
                <img class="jltma-icon-image" src="<?php echo MELA_ADMIN_ASSETS; ?>icons/contribute.svg" alt="Request a Feature">
                <h4>
            ...
            <div class="jltma-master-addons-right-column-widget">
                <img class="jltma-icon-image" src="<?php echo MELA_ADMIN_ASSETS; ?>icons/newsletter.svg" alt="Subscript to Newsletter">
                <h4>

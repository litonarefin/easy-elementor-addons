        ...
        <?php if (ma_el_fs()->is_plan__premium_only('developer')) { ?>
            <div class="jltma-tab-dashboard-header-wrapper">
                <div class="jltma-tab-dashboard-header-right is-flex">
                    <button type="submit" class="jltma-button jltma-tab-element-save-setting" <?php if (ma_el_fs()->is_plan__premium_only('developer')) { ?> data-lic="valid" <?php } ?>>
                ...
                <?php if (!ma_el_fs()->is_plan__premium_only('developer')) { ?>
                    <div class="jltma-addons-white-label-notice">
                        <div class="jltma-addons-white-label-notice-content">
                            ...
                            <a class="jltma-button jltma-get-pro" href="<?php echo esc_url('https://master-addons.com/pricing/'); ?>" target="_blank"><?php _e('Get PRO', MELA_TD); ?></a>
                        </div>
                    </div>
                <?php } ?>
                <div class="jltma-addons-dashboard-tabs-wrapper">
                    <div class="jltma-master-addons-dashboard-filter is-flex">
                        ...
                        <div class="jltma-api-settings-element jltma-half">
                            <h4 class="mt-0"><?php echo esc_html__('White Label Settings', MELA_TD); ?></h4>
                            <div class="jltma-api-element-inner">
                                <div class="jltma-api-forms">
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_name" type="text" class="jltma-form-control jltma_wl_plugin_name" value="<?php echo isset($jltma_white_label_options['jltma_wl_plugin_name']) ? $jltma_white_label_options['jltma_wl_plugin_name'] : ""; ?>">
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <textarea name="jltma_wl_plugin_desc" type="text" class="jltma-form-control jltma_wl_plugin_desc" cols="50"><?php echo isset($jltma_white_label_options['jltma_wl_plugin_desc']) ? $jltma_white_label_options['jltma_wl_plugin_desc'] : ""; ?></textarea>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_author_name" type="text" class="jltma-form-control jltma_wl_plugin_author_name" value="<?php echo isset($jltma_white_label_options['jltma_wl_plugin_author_name']) ? $jltma_white_label_options['jltma_wl_plugin_author_name'] : ""; ?>">
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_menu_label" type="text" class="jltma-form-control jltma_wl_plugin_menu_label" value="<?php echo isset($jltma_white_label_options['jltma_wl_plugin_menu_label']) ? $jltma_white_label_options['jltma_wl_plugin_menu_label'] : ""; ?>">
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_url" type="text" class="jltma-form-control jltma_wl_plugin_url" value="<?php echo isset($jltma_white_label_options['jltma_wl_plugin_url']) ? $jltma_white_label_options['jltma_wl_plugin_url'] : ""; ?>">
                                    </div>
                                    <div class="jltma-form-group is-flex">
                                        <label for="jltma_wl_plugin_row_links">
                                            <?php echo esc_html__('Hide Plugin Row Meta Links', MELA_TD); ?>
                                        </label>
                                        <input name="jltma_wl_plugin_row_links" type="checkbox" class="jltma-form-control jltma_wl_plugin_row_links" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_row_links'], true) ?>>
                        ...
                        <div class="jltma-api-settings-element jltma-half">
                            <h4 class="mt-0"><?php echo esc_html__('Admin Settings', MELA_TD); ?></h4>
                            <div class="jltma-api-element-inner">
                                <div class="jltma-api-forms">
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_welcome" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_welcome" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_welcome'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_addons" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_addons" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_addons'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_extensions" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_extensions" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_extensions'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_api" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_api" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_api'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_white_label" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_white_label" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_white_label'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_version" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_version" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_version'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_changelogs" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_changelogs" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_changelogs'], true) ?>>
                                    </div>
                                    ...
                                    <div class="jltma-form-group is-flex">
                                        ...
                                        <input name="jltma_wl_plugin_tab_system_info" type="checkbox" class="jltma-form-control jltma_wl_plugin_tab_system_info" <?php checked(1, $jltma_white_label_options['jltma_wl_plugin_tab_system_info'], true) ?>>
                                    </div>

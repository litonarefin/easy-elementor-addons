									...
									<div class="master-addons-dashboard-checkbox-content">
										...
										<div class="master-addons-el-title">
											<div class="master-addons-el-title-content">
												<?php echo $jltma_extensions['jltma-extensions']['extension'][$key]['title']; ?>
											</div> <!-- master-addons-el-title-content -->
											<div class="ma-el-tooltip">
												<?php
												Master_Addons_Helper::jltma_admin_tooltip_info('Demo', $jltma_extensions['jltma-extensions']['extension'][$key]['demo_url'], 'eicon-device-desktop');
												Master_Addons_Helper::jltma_admin_tooltip_info('Documentation', $jltma_extensions['jltma-extensions']['extension'][$key]['docs_url'], 'eicon-info-circle-o');
												Master_Addons_Helper::jltma_admin_tooltip_info('Video Tutorial', $jltma_extensions['jltma-extensions']['extension'][$key]['tuts_url'], 'eicon-video-camera');
												?>
											</div>
										...
										<div class="master_addons_feature_switchbox">
											<label for="<?php echo esc_attr($extension); ?>" class="switch switch-text switch-primary switch-pill <?php
												...
												<?php if (ma_el_fs()->can_use_premium_code()) { ?>
													...
													<input type="checkbox" id="<?php echo esc_attr($extension); ?>" class="switch-input" name="<?php echo esc_attr($extension); ?>" <?php checked(1, $this->maad_el_get_extension_settings[$extension], true); ?>>
												...
												<?php } else {
													...
													<input type="checkbox" id="<?php echo esc_attr($extension); ?>" class="switch-input " name="<?php echo esc_attr($extension); ?>" <?php
